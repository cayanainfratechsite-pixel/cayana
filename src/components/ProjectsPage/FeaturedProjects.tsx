...
//                 <p className="text-sm text-zinc-500">{project.locationName || "N/A"}</p>
//                 <p className="text-sm font-medium text-[#0553F1] mt-1">
//                   <span className="font-bold">RERA NO: </span> {project.basePrice || "N/A"}
//                 </p>
...
//                     <div>
//                       <p className="text-sm font-light text-zinc-700">Type</p>
//                       <p className="text-sm font-medium text-zinc-900">{project.type || "N/A"}</p>
//                     </div>
//                   </div>
...
//                     <FaRulerCombined className="text-zinc-500 mr-2" />
//                     <div>
//                       <p className="text-sm font-light text-zinc-700">Category</p>
//                       <p className="text-sm font-medium text-zinc-900">{project.size || "N/A"}</p>
//                     </div>
//                   </div>
...
//                     <FaLayerGroup className="text-zinc-500 mr-2" />
//                     <div>
//                       <p className="text-sm font-light text-zinc-700">Total Units</p>
//                       <p className="text-sm font-medium text-zinc-900">{project.units || "N/A"}</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
